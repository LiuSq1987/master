...
-- meteorological data
-------------------------------------------------------------------------------------------------------------
CREATE TABLE tmp_meteorological_station
(
	station_no				CHAR(5),
...
CREATE TABLE tmp_meteorological_element_data
(
...
CREATE TABLE tmp_meteorological_forecast_data
(
	record_time				TIMESTAMP, --起报时间
	city					VARCHAR(64), --城市
...
CREATE TABLE tmp_water_station
(
	station_no            CHAR(14),          --监测站代码
	station_name          VARCHAR(64),       --监测站名称
	drainage_code         VARCHAR(64),       --流域代码
	area_code             VARCHAR(64),       --地区代码
...
CREATE TABLE tmp_water_quality_data
(
	station_no            CHAR(14),         --监测站代码
	station_name          VARCHAR(64),      --监测站名称
